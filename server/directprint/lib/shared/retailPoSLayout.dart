...
Future<void> retailPoSLayout(BluetoothPrint bluetoothPrint, String data) async {
  print(data);
  ...
  list.add(LineText(type: LineText.TYPE_TEXT,content: "TRX: "+oData["NoTRX"],weight: 0,align: LineText.ALIGN_LEFT,linefeed: 1));
