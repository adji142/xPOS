...
class PenerimaanKonsinyasiHeader extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('penerimaankonsinyasiheader', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('penerimaankonsinyasiheader');
    }
}
