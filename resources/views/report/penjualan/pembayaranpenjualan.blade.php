	...
	<div class="container-fluid">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb bg-white mb-0 px-0 py-2">
				<li class="breadcrumb-item active" aria-current="page">Pembayaran Penjualan 2</li>
			</ol>
		</nav>
	</div>
</div>
						...
						<div class="card card-custom gutter-b bg-transparent shadow-none border-0" >
							<div class="card-header align-items-center  border-bottom-dark px-0">
								<div class="card-title mb-0">
									<h3 class="card-label mb-0 font-weight-bold text-body">Pembayaran Penjualan 
									</h3>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-12  px-4">
						<div class="card card-custom gutter-b bg-white border-0" >
							...
							<div class="card-body" >
                                <form action="{{ route('report-pembayaranpenjualan') }}">
                                    <div class="row">
                                        <div class="col-md-3">
                ...
                switch (e.format) {
                    case "xlsx":
                        ...
                        DevExpress.excelExporter.exportDataGrid({
                            ...
                            saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'Laporan Pembayaran Penjualan.xlsx');
                            });
                        });
                        break;
                    case "pdf":
                        ...
                        DevExpress.pdfExporter.exportDataGrid({
                            ...
                            const header = 'Laporan Rekap Pembayaran Penjualan Periode ' + TglAwal[2]+"/"+TglAwal[1]+"/"+TglAwal[0] + " s/d " + TglAkhir[2]+"/"+TglAkhir[1]+"/"+TglAkhir[0];
                            const pageWidth = doc.internal.pageSize.getWidth();
                            const headerWidth = doc.getTextDimensions(header).w;

                            doc.setFontSize(15);
                            doc.text(header, (pageWidth - headerWidth) / 2, 20);
                            doc.save('Laporan Rekap Pembayaran Penjualan.pdf');
                        });
                        break;
                }
            },
