						...
						<div class="card card-custom gutter-b bg-transparent shadow-none border-0" >
							<div class="card-header align-items-center  border-bottom-dark px-0">
								<div class="card-title mb-0">
									<h3 class="card-label mb-0 font-weight-bold text-body">Penjualan 
									</h3>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-12  px-4">
						<div class="card card-custom gutter-b bg-white border-0" >
							...
							<div class="card-body" >
                                <form action="{{ route('report-penjualan') }}">
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select name="TipeLaporan" id="TipeLaporan" class="js-example-basic-single js-states form-control bg-transparent" >
                                                <option value="1" {{$oldTipeLaporan == "1" ? 'selected' : '' }}>Rekap Penjualan</option>
                                                <option value="2" {{$oldTipeLaporan == "2" ? 'selected' : '' }}>Detail Penjualan</option>
                                                <option value="3" {{$oldTipeLaporan == "3" ? 'selected' : '' }}>Penjualan Per Item</option>
                                                <option value="4" {{$oldTipeLaporan == "4" ? 'selected' : '' }}>Penjualan Per Pelanggan</option>
                                                <option value="5" {{$oldTipeLaporan == "5" ? 'selected' : '' }}>Penjualan Per Sales</option>
...
<script type="text/javascript">
            ...
            columns: [
                ...
                },
                {
                    ...
                    calculateCellValue:function (rowData) {
                        return rowData.TotalPembayaran - rowData.TotalPembelian
                    },
                    allowExporting: true
                },
            ],
                ...
                switch (e.format) {
                    case "xlsx":
                        ...
                        DevExpress.excelExporter.exportDataGrid({
                            ...
                            saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'Laporan Rekap Penjualan.xlsx');
                            });
                        });
                        break;
                    case "pdf":
                        ...
                        DevExpress.pdfExporter.exportDataGrid({
                            ...
                            const header = 'Laporan Rekap Penjualan Periode ' + TglAwal[2]+"/"+TglAwal[1]+"/"+TglAwal[0] + " s/d " + TglAkhir[2]+"/"+TglAkhir[1]+"/"+TglAkhir[0];
                            const pageWidth = doc.internal.pageSize.getWidth();
                            const headerWidth = doc.getTextDimensions(header).w;

                            doc.setFontSize(15);
                            doc.text(header, (pageWidth - headerWidth) / 2, 20);
                            doc.save('Laporan Rekap Penjualan.pdf');
                        });
                        break;
                }
            },
                ...
                switch (e.format) {
                    case "xlsx":
                        ...
                        DevExpress.excelExporter.exportDataGrid({
                            ...
                            workbook.xlsx.writeBuffer().then((buffer) => {
                            saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'Laporan Detail Penjualan.xlsx');
                            });
                        });
                        break;
                    case "pdf":
                        ...
                        DevExpress.pdfExporter.exportDataGrid({
                            ...
                            doc.setFontSize(15);
                            doc.text(header, (pageWidth - headerWidth) / 2, 20);
                            doc.save('Laporan Detail Penjualan.pdf');
                        });
                        break;
                }
            },
                ...
                switch (e.format) {
                    case "xlsx":
                        ...
                        DevExpress.excelExporter.exportDataGrid({
                            ...
                            workbook.xlsx.writeBuffer().then((buffer) => {
                            saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'Laporan Penjualan Per Item.xlsx');
                            });
                        });
                        break;
                    case "pdf":
                        ...
                        DevExpress.pdfExporter.exportDataGrid({
                            ...
                            doc.setFontSize(15);
                            doc.text(header, (pageWidth - headerWidth) / 2, 20);
                            doc.save('Laporan Penjualan Per Item.pdf');
                        });
                        break;
                }
            },
                ...
                switch (e.format) {
                    case "xlsx":
                        ...
                        DevExpress.excelExporter.exportDataGrid({
                            ...
                            workbook.xlsx.writeBuffer().then((buffer) => {
                            saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'Laporan Penjualan Per Pelanggan.xlsx');
                            });
                        });
                        break;
                    case "pdf":
                        ...
                        DevExpress.pdfExporter.exportDataGrid({
                            ...
                            doc.setFontSize(15);
                            doc.text(header, (pageWidth - headerWidth) / 2, 20);
                            doc.save('Laporan Penjualan Per Pelanggan.pdf');
                        });
                        break;
                }
            },
    ...
    function bindGridPerSales(data) {
                ...
                switch (e.format) {
                    case "xlsx":
                        ...
                        DevExpress.excelExporter.exportDataGrid({
                            ...
                            workbook.xlsx.writeBuffer().then((buffer) => {
                            saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'Laporan Penjualan Per Sales.xlsx');
                            });
                        });
                        break;
                    case "pdf":
                        ...
                        DevExpress.pdfExporter.exportDataGrid({
                            ...
                            doc.setFontSize(15);
                            doc.text(header, (pageWidth - headerWidth) / 2, 20);
                            doc.save('Laporan Penjualan Per Sales.pdf');
                        });
                        break;
                }
            },
