				...
				<div class="row">
					<div class="col-12  px-4">
						<div class="card card-custom gutter-b bg-white border-0" >
							...
							<div class="card-body" >
                                <form action="{{ route('report-returpembelian') }}">
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select name="TipeLaporan" id="TipeLaporan" class="js-example-basic-single js-states form-control bg-transparent" >
                                                <option value="1" {{$oldTipeLaporan == "1" ? 'selected' : '' }}>Rekap Retur Pembelian</option>
                                                <option value="2" {{$oldTipeLaporan == "2" ? 'selected' : '' }}>Detail Retur Pembelian</option>
                                                <option value="3" {{$oldTipeLaporan == "3" ? 'selected' : '' }}>Retur Pembelian Per Item</option>
                                                <option value="4" {{$oldTipeLaporan == "4" ? 'selected' : '' }}>Retur Pembelian Per Supplier</option>
                ...
                switch (e.format) {
                    case "xlsx":
                        ...
                        DevExpress.excelExporter.exportDataGrid({
                            ...
                            saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'Laporan Rekap Retur Pembelian.xlsx');
                            });
                        });
                        break;
                    case "pdf":
                        ...
                        DevExpress.pdfExporter.exportDataGrid({
                            ...
                            const header = 'Laporan Rekap Retur Pembelian Periode ' + TglAwal[2]+"/"+TglAwal[1]+"/"+TglAwal[0] + " s/d " + TglAkhir[2]+"/"+TglAkhir[1]+"/"+TglAkhir[0];
                            const pageWidth = doc.internal.pageSize.getWidth();
                            const headerWidth = doc.getTextDimensions(header).w;

                            doc.setFontSize(15);
                            doc.text(header, (pageWidth - headerWidth) / 2, 20);
                            doc.save('Laporan Rekap Retur Pembelian.pdf');
                        });
                        break;
                }
            },
                ...
                switch (e.format) {
                    case "xlsx":
                        ...
                        DevExpress.excelExporter.exportDataGrid({
                            ...
                            workbook.xlsx.writeBuffer().then((buffer) => {
                            saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'Laporan Detail Retur Pembelian.xlsx');
                            });
                        });
                        break;
                    case "pdf":
                        ...
                        DevExpress.pdfExporter.exportDataGrid({
                            ...
                            doc.setFontSize(15);
                            doc.text(header, (pageWidth - headerWidth) / 2, 20);
                            doc.save('Laporan Detail Retur Pembelian.pdf');
                        });
                        break;
                }
            },
                ...
                switch (e.format) {
                    case "xlsx":
                        ...
                        DevExpress.excelExporter.exportDataGrid({
                            ...
                            workbook.xlsx.writeBuffer().then((buffer) => {
                            saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'Laporan Retur Pembelian Per Item.xlsx');
                            });
                        });
                        break;
                    case "pdf":
                        ...
                        DevExpress.pdfExporter.exportDataGrid({
                            ...
                            doc.setFontSize(15);
                            doc.text(header, (pageWidth - headerWidth) / 2, 20);
                            doc.save('Laporan Retur Pembelian Per Item.pdf');
                        });
                        break;
                }
            },
                ...
                switch (e.format) {
                    case "xlsx":
                        ...
                        DevExpress.excelExporter.exportDataGrid({
                            ...
                            workbook.xlsx.writeBuffer().then((buffer) => {
                            saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'Laporan Retur Pembelian Per Supplier.xlsx');
                            });
                        });
                        break;
                    case "pdf":
                        ...
                        DevExpress.pdfExporter.exportDataGrid({
                            ...
                            doc.setFontSize(15);
                            doc.text(header, (pageWidth - headerWidth) / 2, 20);
                            doc.save('Laporan Retur Pembelian Per Supplier.pdf');
                        });
                        break;
                }
            },
