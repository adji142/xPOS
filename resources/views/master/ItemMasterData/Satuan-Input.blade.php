	...
	<div class="container-fluid">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb bg-white mb-0 px-0 py-2">
				...
				<li class="breadcrumb-item active" aria-current="page">Input Satuan</li>
			</ol>
		</nav>
	</div>
</div>
							...
							<div class="card-body" >
                            	...
                            	@endif
	                            	...
	                            	<div class="form-group row">
	                            		...
	                            		<div class="col-md-12">
	                            			<label  class="text-body">Nama Satuan</label>
	                            			<fieldset class="form-group mb-3">
	                            				<input type="text" class="form-control" id="NamaSatuan" name="NamaSatuan" placeholder="Masukan Nama Satuan" value="{{ count($satuan) > 0 ? $satuan[0]['NamaSatuan'] : '' }}" required="">
	                            			</fieldset>
