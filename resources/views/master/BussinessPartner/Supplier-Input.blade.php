							...
							<div class="card-body" >
                            	...
                            	@endif
	                            	...
	                            	<div class="form-group row">
	                            		...
	                            		<div class="col-md-12">
	                            			<label  class="text-body">Nama Supplier (*)</label>
	                            			<fieldset class="form-group mb-3">
	                            				<input type="text" class="form-control" id="NamaSupplier" name="NamaSupplier" placeholder="Masukan Nama Supplier" value="{{ count($supplier) > 0 ? $supplier[0]['NamaSupplier'] : '' }}" required="">
	                            			</fieldset>
	                            			...
	                            			<fieldset class="form-group mb-3">
	                            				<select name="ProvID" id="ProvID" class="js-example-basic-single js-states form-control bg-transparent" name="state" >
													...
													@foreach($provinsi as $ko)
														<option 
                                                            value="{{ $ko->prov_id }}"
                                                            {{ count($supplier) > 0 ? $supplier[0]['ProvID'] == 4 ? "selected" : '' :""}}
                                                        >
                                                            {{ $ko->prov_name }}
                                                        </option>
													@endforeach
	                            		...
	                            		<div class="col-md-6">
	                            			...
	                            			<fieldset class="form-group mb-3">
	                            				<input type="mail" class="form-control" id="Email" name="Email" placeholder="Masukan Email" value="{{ count($supplier) > 0 ? $supplier[0]['Email'] : '' }}" >
	                            			</fieldset>
	                            		</div>
	                            		...
	                            		<div class="col-md-3">
	                            			...
	                            			<fieldset class="form-group mb-3">
	                            				<input type="number" class="form-control" id="NoTlp1" name="NoTlp1" placeholder="621325058258" value="{{ count($supplier) > 0 ? $supplier[0]['NoTlp1'] : '' }}" required="">
	                            			</fieldset>
	                            		</div>
	                            		...
	                            		<div class="col-md-3">
	                            			...
	                            			<fieldset class="form-group mb-3">
	                            				<input type="number" class="form-control" id="NoTlp2" name="NoTlp2" placeholder="621325058258" value="{{ count($supplier) > 0 ? $supplier[0]['NoTlp2'] : '' }}" >
	                            			</fieldset>
	                            		</div>
	                            		...
	                            		<div class="col-md-12">
	                            			...
	                            			<fieldset class="form-group mb-3">
	                            				<select name="Status" id="Status" class="js-example-basic-single js-states form-control bg-transparent" name="state" >
													<option value="1" {{ count($supplier) > 0 ? $supplier[0]['Status'] == 1 ? "selected" : '' :""}}>Active</option>
													<option value="0" {{ count($supplier) > 0 ? $supplier[0]['Status'] == 0 ? "selected" : '' :""}}>Inactive</option>
												</select>
	                            			</fieldset>
