					...
					<div id="tc_aside_menu" class="aside-menu  mb-5" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
						...
						<div id="accordion">
							<ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="collapse"  href="javascript:void(0)" data-bs-target="#Master" role="button" aria-expanded="false" aria-controls="Master">
                                        <span class="svg-icon nav-icon">
                                ...
                                <div class="collapse nav-collapse" id="Master" data-bs-parent="#accordion">
                                    <div id="accordion1">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="collapse"  href="javascript:void(0)" data-bs-target="#Transaksi" role="button" aria-expanded="false" aria-controls="Transaksi">
                                        <span class="svg-icon nav-icon">
                                            <i class="fas fa-boxes font-size-h4"></i>
                                        </span>
                                ...
                                <div class="collapse nav-collapse" id="Transaksi" data-bs-parent="#accordion">
                                    <div id="accordion1">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
