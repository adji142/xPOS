		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb bg-white mb-0 px-0 py-2">
				<li class="breadcrumb-item active" aria-current="page">
					<a href="{{route('retcons')}}">Daftar Retur Konsinyasi</a>
				</li>
								...
								<div class="card-title mb-0">
									<h3 class="card-label mb-0 font-weight-bold text-body">
										@if (count($returheader) > 0)
                                    		...
                                    		Edit Retur Konsinyasi
	                                	@else
	                                		<input type="hidden" name="formtype" id="formtype" value="add">
	                                    	Tambah Retur Konsinyasi
	                                	@endif
									</h3>
								</div>
							</div>
						...
						<div class="card card-custom gutter-b bg-white border-0" >
							<div class="card-body" >
                            	<div class="form-group row">
                            		...
                            		<div class="col-md-12">
                            			<label  class="text-body">Isi Nomor Penerimaan Konsinyasi</label>
                            			<fieldset class="form-group mb-3">
                            				<div id="gridBox"></div>
                            			</fieldset>
                            		</div>
		            ...
		            success: function(response) {
		            	if (response.success == true) {
		            		Swal.fire({
		                        ...
		                        // location.reload();
		                        window.location.href = '{{url("retcons")}}';
		                    });
		            	}
		            	else{
		            		Swal.fire({
