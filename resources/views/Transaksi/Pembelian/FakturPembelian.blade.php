						...
						<div class="card card-custom gutter-b bg-transparent shadow-none border-0" >
							<div class="card-header align-items-center  border-bottom-dark px-0">
								<div class="card-title mb-0">
									<h3 class="card-label mb-0 font-weight-bold text-body">Faktur Pembelian 
									</h3>
								</div>
							    <div class="icons d-flex">
									<a href="{{ url('fpembelian/form/-') }}" class="btn btn-outline-primary rounded-pill font-weight-bold me-1 mb-1">Tambah Data</a>
...
<script type="text/javascript">
    ...
    function showCetakModal(noTransaksi) {
        var url = documentBaseUrl + "?NomorTransaksi=" + encodeURIComponent(noTransaksi) + "&TipeTransaksi=fakturpembelian";
