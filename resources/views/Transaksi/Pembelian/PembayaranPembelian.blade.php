						...
						<div class="card card-custom gutter-b bg-transparent shadow-none border-0" >
							<div class="card-header align-items-center  border-bottom-dark px-0">
							    ...
							    <div class="icons d-flex">
									<a href="{{ url('pembayaranpembelian/form/-') }}" class="btn btn-outline-primary rounded-pill font-weight-bold me-1 mb-1">Tambah Data</a>
...
<script type="text/javascript">
    ...
    function showCetakModal(noTransaksi) {
        var url = documentBaseUrl + "?NomorTransaksi=" + encodeURIComponent(noTransaksi) + "&TipeTransaksi=pembayaranpembelian";
    ...
    function GetHeader() {
        $.ajax({
            async:false,
            type: 'post',
            url: "{{route('pembayaranpembelian-readheader')}}",
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}' // Include the CSRF token in the headers
            },
            data: {
    ...
    function GetDetail(NoTransaksi) {
        $.ajax({
            async:false,
            type: 'post',
            url: "{{route('pembayaranpembelian-readdetail')}}",
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}' // Include the CSRF token in the headers
            },
            data: {
            ...
            columns: [
                ...
                },
                {
                    ...
                    cellTemplate: function(cellElement, cellInfo) {
                        var link = "pembayaranpembelian/form/"+cellInfo.data.NoTransaksi;
