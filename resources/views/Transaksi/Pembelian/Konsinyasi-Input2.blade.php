		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb bg-white mb-0 px-0 py-2">
				<li class="breadcrumb-item active" aria-current="page">
					<a href="{{route('cons')}}">Daftar Konsinyasi</a>
				</li>
                            	...
                            	<div class="form-group row">
                            		<div class="col-md-3">
                            			...
                            			<fieldset class="form-group mb-3">
                            				<input type="text" class="form-control" id="NoTransaksi" name="NoTransaksi" placeholder="<Auto>" value="{{ count($konsinyasiheader) > 0 ? $konsinyasiheader[0]['NoTransaksi'] : '' }}" required="">
                            			</fieldset>
                            		...
                            		<div class="col-md-3">
                            			...
                            			<fieldset class="form-group mb-3">
                            				<select name="Status" id="Status" class="js-example-basic-single js-states form-control bg-transparent" >
												<option value="O" {{ count($konsinyasiheader) > 0 ? $konsinyasiheader[0]['Status'] == 'O' ? "selected" : '' :""}} >OPEN</option>
												<option value="C" {{ count($konsinyasiheader) > 0 ? $konsinyasiheader[0]['Status'] == 'C' ? "selected" : '' :""}} >CLOSE</option>
												<option value="D" {{ count($konsinyasiheader) > 0 ? $konsinyasiheader[0]['Status'] == 'D' ? "selected" : '' :""}}>CANCEL</option>
                            			...
                            			<fieldset class="form-group mb-3">
                            				<select name="KodeTermin" id="KodeTermin" class="js-example-basic-single js-states form-control bg-transparent" >
												...
												@foreach($termin as $ko)
													<option 
                                                        value="{{ $ko->id }}"
                                                        {{ count($konsinyasiheader) > 0 ? $konsinyasiheader[0]['KodeTermin'] == $ko->id ? "selected" : '' :""}}
                                                    >
                                                        {{ $ko->NamaTermin }}
                                                    </option>
												@endforeach
                            		...
                            		<div class="col-md-3">
                            			...
                            			<fieldset class="form-group mb-3">
                            				<input type="date" class="form-control" id="TglTransaksi" name="TglTransaksi" placeholder="<Auto>" value="{{ count($konsinyasiheader) > 0 ? $konsinyasiheader[0]['TglTransaksi'] : '' }}" required="">
                            			</fieldset>
                            		</div>
                            		...
                            		<div class="col-md-3">
                            			...
                            			<fieldset class="form-group mb-3">
                            				<input type="date" class="form-control" id="TglJatuhTempo" name="TglJatuhTempo" placeholder="<Auto>" value="{{ count($konsinyasiheader) > 0 ? $konsinyasiheader[0]['TglJatuhTempo'] : '' }}" required="">
                            			</fieldset>
                            		</div>
                            		...
                            		<div class="col-md-6">
                            			...
                            			<fieldset class="form-group mb-3">
                            				<input type="text" class="form-control" id="NoReff" name="NoReff" placeholder="Masukan No Reff" value="{{ count($konsinyasiheader) > 0 ? $konsinyasiheader[0]['NoReff'] : '' }}" >
                            			</fieldset>
                            		</div>
                            		...
                            		<div class="col-md-12">
                            			...
                            			<fieldset class="form-group mb-3">
                            				<input type="text" class="form-control" id="Keterangan" name="Keterangan" placeholder="Masukan Keterangan" value="{{ count($konsinyasiheader) > 0 ? $konsinyasiheader[0]['Keterangan'] : '' }}" >
                            			</fieldset>
                            		</div>
                            		...
                            		<div class="col-md-5">
                            			<table>
                            				<tr>
                            					<td>Sub Total</td>
                            					<td>:</td>
                            					<td><input type="text" align="right" name="TotalTransaksi" id="TotalTransaksi" class="form-control aligned-textbox" value="{{ count($konsinyasiheader) > 0 ? $konsinyasiheader[0]['TotalTransaksi'] : '0' }}" readonly=""></td>
                            				</tr>
                            				<tr>
                            					<td>Diskon</td>
                            					<td>:</td>
                            					<td><input type="text" align="right" name="Potongan" id="Potongan" readonly="" class="form-control aligned-textbox" value="{{ count($konsinyasiheader) > 0 ? $konsinyasiheader[0]['Potongan'] : '0' }}"></td>
                            				</tr>
                            				<tr>
                            					<td>PPN</td>
                            					<td>:</td>
                            					<td><input type="text" align="right" name="Pajak" id="Pajak" readonly="" class="form-control aligned-textbox" value="{{ count($konsinyasiheader) > 0 ? $konsinyasiheader[0]['Pajak'] : '0' }}"></td>
                            				</tr>
                            				<tr>
                            					<td>Total</td>
                            					<td>:</td>
                            					<td><input type="text" align="right" name="TotalPembelian" id="TotalPembelian" readonly="" class="form-control aligned-textbox" value="{{ count($konsinyasiheader) > 0 ? $konsinyasiheader[0]['TotalPembelian'] : '0' }}"></td>
                            				</tr>
                            			</table>
                            		</div>
		...
		jQuery(document).ready(function() {
			...
			if (jQuery('#formtype').val() == "edit") {
				formatCurrency(jQuery('#TotalTransaksi'), fakturHeader[0]["TotalTransaksi"]);
	      		...
	      		BindGridDetail(<?php echo json_encode($konsinyasidetail) ?>);
	      		// CreateCombobox([])
