	...
	<div class="container-fluid">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb bg-white mb-0 px-0 py-2">
				<li class="breadcrumb-item active" aria-current="page">Penghapusan Barang</li>
			</ol>
		</nav>
	</div>
</div>
						...
						<div class="card card-custom gutter-b bg-transparent shadow-none border-0" >
							<div class="card-header align-items-center  border-bottom-dark px-0">
								<div class="card-title mb-0">
									<h3 class="card-label mb-0 font-weight-bold text-body">Penghapusan Stock Barang 
									</h3>
								</div>
							    <div class="icons d-flex">
									<a href="{{ url('gi/form/-') }}" class="btn btn-outline-primary rounded-pill font-weight-bold me-1 mb-1">Tambah Data</a>
						...
						<div class="card card-custom gutter-b bg-white border-0" >
							<div class="card-body" >
								<div class="dx-viewport demo-container">
				                	<div id="data-giid-demo">
				                  		<div id="giidContainerHeader"></div>
				                	</div>
				              	</div>
							</div>
							...
							<div class="card-body" >
								<div class="dx-viewport demo-container">
				                	<div id="data-giid-demo">
				                  		<div id="giidContainerDetail"></div>
				                	</div>
				              	</div>
							</div>
						</div>
...
<script type="text/javascript">
	...
	function bindGridHeader(data) {
		var dataGridInstance = jQuery("#giidContainerHeader").dxDataGrid({
            ...
            columns: [
                ...
                },
                {
                    ...
                    cellTemplate: function(cellElement, cellInfo) {
                        var link = "gi/form/"+cellInfo.data.NoTransaksi;
                        var LinkAccess = "";
	...
	function bindGridDetail(data) {
		var dataGridInstance = jQuery("#giidContainerDetail").dxDataGrid({
			allowColumnResizing: true,
			dataSource: data,
			keyExpr: "NoUrut",
			showBorders: true,
